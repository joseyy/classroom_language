...
__global__ void multiply_matrices(float *a, float *b, float *result, size_t m, size_t n, size_t p);

void multiply_matrices_wrapper(float *a, float *b, float *result, size_t m, size_t n, size_t p, dim3 blocksPerGrid, dim3 threadsPerBlock);
